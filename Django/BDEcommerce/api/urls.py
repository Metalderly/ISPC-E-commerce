...
from api.views import UserView, UserByIdView, ProductView, UserByUsernameView, ProductByUsernameView, ProductByIdView

urlpatterns = [
    path('v1/users', UserView.as_view()),
    path('v1/user/<str:username>/<str:password>', UserByUsernameView.as_view()),
